...
<head>
    ...
    <title>NMTC | Reset Password</title>
    <meta charset="utf-8" />
        ...
        <div class="d-flex flex-column flex-column-fluid flex-lg-row">
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h2 class="text-white fw-normal m-0">Can you hear the drumming <b>There’s a revolution coming</h2>
                    <!--end::Title-->
                </div>
                <!--begin::Aside-->
            </div>
                        ...
                        <form class="form w-100" novalidate="novalidate" method="POST"
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" placeholder="Email" name="email"
                                    value="{{ $email ?? old('email') }}" autocomplete="off"
