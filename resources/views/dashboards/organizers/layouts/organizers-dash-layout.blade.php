...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                                    ...
                                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0"
                                        ...
                                        <div class="menu-item  me-0 me-lg-2">
                                            ...
                                            <span class="menu-link py-3">
                                                <span class="menu-title"><a style="color:white;"
                                                        href="{{ route('organizer.account') }}">Account</a></span>
                                        ...
                                        @if (Auth::user()->role == 3)
                                            <div class="menu-item me-0 me-lg-2">
                                                ...
                                                <span class="menu-link py-3">
                                                    <span class="menu-title"><a style="color:white;"
                                                            href="{{ route('organizer.dashboard') }}">Dashboard</a></span>
                                                    <span class="menu-arrow d-lg-none"></span>
                                                </span>
                                                <!--end:Menu link-->
                                        ...
                                        <div class="menu-item  me-0 me-lg-2">
                                            ...
                                            <span class="menu-link py-3">
                                                <span class="menu-title"><a style="color:white;"
                                                        href="{{ route('organizer.participants') }}">Participants
                                                        List</a></span>
                                                <span class="menu-arrow d-lg-none"></span>
                                            </span>
                                            <!--end:Menu link-->
                                ...
                                <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bold d-flex align-items-center fs-5">
                                                        {{ Auth::user()->name }}
                                                        <span
                                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Org</span>
                                                    </div>
                                                    <a href="#"
                                        ...
                                        <div class="menu-item px-5">
                                            <a class="menu-link px-5"href="{{ route('organizer.profile') }}"
                                                onclick="event.preventDefault();
                                                        document.getElementById('profile').submit();">
                                                Profile</a>
                                            <form id="profile" action="{{ route('organizer.profile') }}"
    ...
    <script src="{{ asset('assets/js/createOrJoin2.js') }}"></script>
    ...
    <script>
        function clean_update(id, name, status_pack, status_bus, total, paidMoney, busFee) {
    ...
    <script>
        ...
        uppy.use(Uppy.XHRUpload, {
            endpoint: '{{ route('organizer.uploadBankTransfer') }}',
