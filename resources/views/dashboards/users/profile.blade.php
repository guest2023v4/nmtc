                    ...
                    <div class="card card-flush" data-kt-sticky="true" data-kt-sticky-name="account-navbar"
                        ...
                        <div class="card-body pt-0 p-10">
                            ...
                            <ul
                                ...
                                <li class="menu-item mb-1">
                                    <!--begin::Menu link-->
                                    <a class="menu-link px-6 py-4" href="{{ route('user.settings') }}">
                                        <span class="menu-bullet"><span class="bullet"></span></span>
                                        <span class="menu-title">
                                            Settings </span>
                                    </a>
                ...
                <div class="flex-lg-row-fluid ms-lg-10">
                    ...
                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                        ...
                        <div class="card-header cursor-pointer">
                            ...
                            <!--begin::Action-->
                            <a href="{{ route('user.settings') }}" class="btn btn-primary align-self-center">Edit
                                Profile</a>
                            <!--end::Action-->
                        </div>
                        <!--begin::Card header-->
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 ">
                                        ...
                                        <div class=" fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 ">Your CIN is not uploaded yet ! <a
                                                    class="fw-bold" href="{{ route('user.uploadCIN') }}">Upload CIN</a>.
                                            </div>
                                        </div>
                                        <!--end::Content-->
