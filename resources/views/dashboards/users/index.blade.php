                ...
                <div class="card mb-5 mb-xxl-8">
                    <div class="card-body mt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            @if ((Auth::user()->role == '4' && $data['c_teams'] == 1) || Auth::user()->team_id != null)
                                <li class="nav-item mt-2">
                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 @if ($routeto == 'team') active @endif"
                                        data-bs-toggle="tab" href="#kt_tab_pane_6"
                                        onclick="clearOpen('#kt_tab_pane_6')">Team</a>
                                </li>
                            @endif
                            @if ($data['c_payment'] == 1)
                                @if ($payment_cond)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                                            ...
                                            @else
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <ul
                                                        ...
                                                        @if (isset($data['room_leader']) && Auth::user()->id == $data['room']->room_leader_id)
                                                            <li class="nav-item">
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        ...
                                                        @if (isset($data['room_leader']) && Auth::user()->id == $data['room_leader']['id'])
                                                            <div class="tab-pane fade" id="nmtc_room_inv"
                                                                role="tabpanel">
                                                                                    ...
                                                                                    @foreach ($data['room_join_requests'] as $join_request)
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="d-flex flex-row">
                                                                                                @if($data['c_rooms'] == 1)
                                                                                                <form method="POST"
                                                                                                    action="{{ route('rejectJoinRequest') }}">
                                                                                                    @csrf
                                                                                                    <button type="submit"
                                                                                                ...
                                                                                                <form method="POST"
                                                                                                    action="{{ route('acceptJoinRequest') }}">
                                                                                                    @csrf
                                                                                                    <button type="submit"
                                                                                                        value="{{ $join_request['id'] }}"
                                                                                                        name="id"
                            ...
                            <div class="card-body p-0 tab-pane fade show " id="kt_tab_pane_5" role="tabpanel">
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <form method="POST" action="{{ route('createJoinRequest') }}">
                                            @csrf
                                                        ...
                                                        <tbody>
                                                            @foreach ($data['rooms_self_join_requests'] as $id => $join_request)
                                                                <tr>
                                                                    ...
                                                                    <td class="d-flex flex-row">
                                                                        <form method="POST"
                                                                            action="{{ route('cancelJoinRequest') }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                                value="{{ $join_request['id'] }}"
                                                                                name="room_id"
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('joinPublicRoom') }}">
                                            @csrf
                                            <div class="d-flex justify-content-end">
                            ...
                            <!--begin::Tab panel-->
                            @if ((Auth::user()->role == 4 && $data['c_teams'] == 1) || Auth::user()->team_id != null)
                                <div class="card-body p-0 tab-pane fade show  @if ($routeto == 'team') active @endif"
                                                    ...
                                                    <div class="pb-7 pb-lg-12 d-flex flex-column justify-content-center">
                                                        ...
                                                        <div class="text-white fw-semibold fs-4 text-center">
                                                            ...
                                                            <span class="link-primary fw-bold">"Create
                                                                Team"</span>
                                                            if you want to create one<br> or <span
                                                                class="link-primary fw-bold">"Join
                                                                Team"</span>
                                                            if
                                                            you already have a room
                                                        </div>
                                                ...
                                                <div class="d-flex justify-content-center mb-15 flex-wrap"
                                                    ...
                                                    <div class="card card-xl-stretch mb-xl-8 mx-6 mb-6"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="pt-5">
                                                                <p class="text-center fs-6">
                                                                <p id="createTeam" class="btn btn-secondary w-100 py-3"
                                                                    style="padding-left: 50px !important;padding-right: 50px !important;">
                                                                    Create
                                                                    a Team</p>
                                                                </p>
                                            ...
                                            @else
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                                                                data-bs-toggle="tab" href="#nmtc_team">Dashboard</a>
                                                        </li>
                                                        @if (isset($data['team']) && Auth::user()->id == $data['team']->team_leader_id)
                                                            <li class="nav-item">
                                                                <a class="nav-link text-active-primary ms-0 me-10 py-5 "
                                                                    data-bs-toggle="tab" href="#nmtc_team_inv">Join
                                                                    requests</a>
                                                            </li>
                                                        @endif
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        <div class="tab-pane fade show active" id="nmtc_team"
                                                            role="tabpanel">
                                                            <div class="d-flex justify-content-center">
                                                                <div
                                                                    class="pb-7 pb-lg-12 d-flex flex-column justify-content-center">
                                                                    <!--begin::Title-->
                                                                    <h1
                                                                        class="fw-bold  text-dark justify-content-center text-center my-1">
                                                                        Team Members &nbsp;<span
                                                                            class="badge badge-success">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="card card-xl-stretch mb-xl-8 mx-6 mt-7"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class=" symbol-50px pt-5">
                                                                                <img style="height: 100px;border-radius: 15px;"
                                                                                    src="{{ asset('assets/media/hackathon.jpg') }}"
                                                                                    alt="" />
                                                                            </div>
                                                                            @if ($data['team']->type == 0)
                                                                                <div class="pt-10">
                                                                                    <div class="d-flex">
                                                                                        ...
                                                                                        <button
                                                                                            id="kt_share_earn_link_copy_button_2"
                                                                                            class="btn btn-light fw-bold flex-shrink-0 h-40px w-40px text-center"
                                                                                            style="padding-left: 0px;
                                    padding-right: 0px;
                                    padding-top: 0px;
                                    padding-bottom: 0px;"
                                                                                            data-clipboard-target="#kt_share_earn_link_input_2"><svg
                                                                                                width="24"
                                                                                                height="24"
                                                                                                viewBox="0 0 24 24"
                                                                                                fill="none"
                                                                        ...
                                                                        <div class="card-footer">
                                                                            ...
                                                                            <p class="text-center fs-3">
                                                                                <span
                                                                                    class="text-white">{{ $data['team']->name }}</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <div class="card-body card-scroll h-300px">
                                                                        ...
                                                                        <div class="row">
                                                                            @if (is_array($data['team_teammates']))
                                                                                @foreach ($data['team_teammates'] as $teamPar)
                                                                                    <!--begin::Mixed Widget 4-->
                                                                                    <div class="card col-md-6 mb-xl-8 mx-2"
                                                                                        style="width: 250px;background-color: #151521 !important;">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="pt-5 mt-5">
                                                                                                <p
                                                                                                    class="text-center fs-4 bold">
                                                                                                    <b>{{ $teamPar['name'] }}</b>
                                                                                                    @if (isset($data['team_leader']) && $teamPar['id'] == $data['team_leader']['id'])
                                                                                                        <span
                                                                                                            class="badge badge-success">C</span>
                                                                                                    @endif
                                                                                                    <span
                                                                                                        class="text-gray-600"><a
                                                                                                            href="mailto:{{ $teamPar['email'] }}">{{ $teamPar['email'] }}</a></span>
                                                                                                    <span
                                                                                                        class="text-gray-600">{{ $teamPar['phone'] }}</span>
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                        <!--end::Body-->
                                                        ...
                                                        @if (isset($data['team_leader']) && Auth::user()->id == $data['team_leader']['id'])
                                                            <div class="tab-pane fade" id="nmtc_team_inv"
                                                                role="tabpanel">
                                                                <div class="table-responsive">
                                                                    <table class="table gs-7 gy-7 gx-7">
                                                                        <thead>
                                                                        ...
                                                                        <tbody>
                                                                            @if (isset($data['team_join_requests']))
                                                                                @foreach ($data['team_join_requests'] as $join_request)
                                                                                    <tr>
                                                                                        <td
                                                                                            class="d-flex align-items-center">
                                                                                            <!--begin:: Avatar -->
                                                                                            <div
                                                                                                ...
                                                                                                <div class="symbol-label">
                                                                                                    <img src="../users/images/{{ $join_request['picture'] }}"
                                                                                                        alt=""
                                                                                                        class="w-100" />
                                                                                                </div>
                                                                                        ...
                                                                                        <td class="d-flex flex-row">
                                                                                            @if($data['c_teams'] == 1)
                                                                                            <form method="POST"
                                                                                                action="{{ route('reject-Join-Team-Request') }}">
                                                                                                @csrf
                                                                                                <button type="submit"
                                                                                                    value="{{ $join_request['id'] }}"
                                                                                                    name="id"
                                                                                            ...
                                                                                            <form method="POST"
                                                                                                action="{{ route('AcceptJoinTeamRequest') }}">
                                                                                                @csrf
                                                                                                <button type="submit"
                                                                                                    value="{{ $join_request['id'] }}"
                                                                                                    name="id"
                                                    ...
                                                    @if ($data['c_teams'] == 1)
                                                    <div class="d-flex justify-content-start">
                                                        <form name="ltform" method="POST"
                                                            action="{{ route('leave-team') }}">
                                                            @csrf


                                                            <span class='fw-bold mt-6  p-6' onclick="ltform.submit()"
                                                                style="cursor: pointer;"><span
                                                                    class='badge badge-light-danger  py-6'
                                                                    style="padding-right: 95px;padding-left: 95px;">Leave
                                                                    Team</span></span>
                            ...
                            <!--end::Tab panel-->
                            <!--begin::Tab panel-->
                            <div class="card-body p-0 tab-pane fade show " id="kt_tab_pane_7" role="tabpanel">
                                <!--begin::Type-->
                                <div class="current" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <div class="w-100">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="pb-7 pb-lg-12 d-flex flex-column justify-content-center">
                                                ...
                                                <div class="text-white fw-semibold fs-4 text-center">Choose
                                                    a
                                                    <span class="link-primary fw-bold"> Name</span>
                                                    for your team
                                                </div>
                                                <!--end::Description-->
                                            </div>
                                        ...
                                        <form method="POST" action="{{ route('CreateATeam') }}">
                                            @csrf
                                            <div class="d-flex justify-content-center mb-15" data-kt-buttons="true">
                                                <!--begin::Mixed Widget 4-->
                                                ...
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <!--begin::Buttons-->
                                                    <div
                                                        class="d-flex flex-stack gap-5 flex-wrap mb-3 justify-content-center">
                                                        <!--begin::Image input-->



                                                        <div class="d-flex flex-column ml-12 row">


                                                            <!--begin::Buttons-->
                                                            <div class="d-flex flex-stack align-self-center gap-5 ">
                                                                <p class="text-white fw-semibold fs-5 text-center align-self-center"
                                                                    style="margin-bottom: 0px;">Team Name
                                                                </p>
                                                    ...
                                                    <input type="text" hidden class="form-control form-control-solid"
                                                        placeholder="Enter Amount" name="TeamSize" />
                                                </div>
                            ...
                            <!--end::Tab panel-->
                            <!--begin::Tab panel-->
                            <div class="card-body p-0 tab-pane fade show " id="kt_tab_pane_8" role="tabpanel">
                                <!--begin::Type-->
                                <div class="current" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <div class="w-100">
                                        ...
                                        <form method="POST" action="{{ route('SendJoinRequest') }}">
                                            @csrf
                                            <div class="d-flex justify-content-center mb-15">
                                                <!--begin::Mixed Widget 4-->
                                                ...
                                                <div class="d-flex flex-column mb-8 row">
                                                    ...
                                                    <div class="d-flex flex-stack align-self-center gap-5 ">
                                                        <p class="text-white fw-semibold fs-5 text-center align-self-center"
                                                            style="margin-bottom: 0px;">Team Invite Code
                                                        </p>
                                        ...
                                        @if (isset($data['teams_self_join_requests']))
                                            <div class="tab-pane" id="nmtc_room_inv" role="tabpanel">
                                                <div class="table-responsive">
                                                    <table class="table gs-7 gy-7 gx-7">
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                            @foreach ($data['teams_self_join_requests'] as $id => $join_request)
                                                                <tr>
                                                                    <td>{{ $id + 1 }}</td>
                                                                    <td>{{ $join_request->code }}</td>
                                                                    <td>Pending</td>
                                                                    ...
                                                                    <td class="d-flex flex-row">
                                                                        <form method="POST"
                                                                            action="{{ route('cancelTeamJoinRequest') }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                                value="{{ $join_request['id'] }}"
                                                                                name="team_id"
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('joinPublicTeam') }}">
                                            @csrf
                                            <!--begin::Actions-->
                                            <div class="d-flex justify-content-end">
                                                <input type="submit" class="btn btn-lg btn-danger w-300px"
                                                    value="Join Public Team">
                                            </div>
                                            <!--end::Actions-->
                                        </form>
                                    </div>
                                            ...
                                            <div class="d-flex justify-content-center mb-15 flex-wrap"
                                                ...
                                                @if (Auth::user()->pay_status_pack == 0 || Auth::user()->pay_status_pack == 2)
                                                    <div class="card card-xl-stretch mb-xl-8 mx-6 mb-6"
                                                        ...
                                                        <!--begin::Body-->
                                                        <div
                                                            class="card-body d-flex flex-column create_btn_sm justify-content-center align-items-center padd-0">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    @foreach ($data['payagents'] as $agent)
                                                        <form method="POST" action="{{ route('choosePaymentAgent') }}">
                                                            @csrf
                                                            <div
                                            ...
                                            <div class="current" data-kt-stepper-element="content">
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="overflow-auto pb-5">
                                                        @foreach ($data['payagents'] as $agent)
                                                            <form method="POST"
                                                                action="{{ route('choosePaymentAgent') }}">
                                                                @csrf
                                                                <div
                                                                    class="d-flex align-items-center border justify-content-between border-dashed 
...
border-gray-300  
                                                ...
                                                rounded min-w-250px px-7 py-3 mb-5">
                                                                    ...
                                                                    <a
                                                                        class="fs-5 text-dark text-hover-primary fw-semibold ">{{ $agent->name }}</a>
                                                                    <a
                                                                        class="fs-5 text-dark text-hover-primary fw-semibold d-none d-md-inline d-none d-md-inline"><span
                                                                            class="svg-icon svg-icon-muted svg-icon-2hx"><svg
                                                                                width="24" height="24"
                                                                                viewBox="0 0 24 24" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <a href="tel:20 000 000"
                                                                        class="fs-5 text-dark text-hover-primary d-none d-md-inline d-none d-md-inline">{{ $agent->phone }}</a>
                                                                    <!--begin::Progress-->
                                                                    <div class="pe-2">
                                                                        <span
                                                                            class="badge @if (Auth::user()->city == $agent->city) badge-light-success @else badge-light-dark @endif">{{ $agent->city }}</span>
                                                        ...
                                                        @if (
                                                            ...
                                                            <div class="drag-drop-area12">
                                                                @if (Auth::user()->bank_transfer)
                                                                    <form action="{{ route('removeBankTransfer') }}"
                                                                        method="Post">
                                                                        @csrf
                                                                        <input type="submit"
