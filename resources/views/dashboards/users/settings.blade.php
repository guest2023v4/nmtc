        ...
        <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">
                        <a href="{{ route('user.dashboard') }}" class="text-white text-hover-primary">
                            Dashboard </a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                        ...
                        <div class="card-body pt-0 p-10">
                            ...
                            <ul
                                ...
                                <li class="menu-item mb-1">
                                    <!--begin::Menu link-->
                                    <a class="menu-link px-6 py-4 " href="{{ route('user.profile') }}">
                ...
                <div class="flex-lg-row-fluid ms-lg-10">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form id="kt_account_profile_details_form" class="form" method="POST"
                                action="{{ route('userUpdateInfo') }}" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    ...
                                    @if ($data['c_reg'])
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <select name="type" aria-label="Select participation type"
                                                    data-control="select2" data-placeholder="Select participation type..."
                                                    class="form-select form-select-solid form-select-lg fw-semibold"
                                                    data-hide-search="true">
                                                    <option value="visitor"
                                                        @if (Auth::user()->role == 5) selected @endif>
                                                        Visitor</option>
                                                    <option value="challenger"
                                                        @if (Auth::user()->role == 4) selected @endif>Challenger
                                                    </option>
                                                </select>
                                                <span class="text-danger">
                                                    @error('type')
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form id="kt_account_profile_details_form" class="form" method="post"
                                action="{{ route('userUpdatePassword') }}">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    <!--begin::Input group-->
