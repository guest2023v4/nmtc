    ...
    <div class="toolbar py-5 " id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-white fw-bold my-1 fs-3">Rooms List</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">Rooms List</li>
                    <!--end::Item-->
                ...
                <div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        ...
                        <div class="px-7 py-5" data-kt-filter="form">
                            <!--begin::Input group-->
                            <div class="mb-5">
                                <p class="form-label fs-6 fw-semibold">Gender :</p>
                                <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input" type="checkbox" name="gender_select" value="Male"
                                        id="gender_select" />
                                    <span class="form-check-label">Male</span>
                                </label>
                                <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input" type="checkbox" name="gender_select" value="Female"
                                        id="gender_select_2" />
                                    <span class="form-check-label">Female</span>
                                </label>
                                <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input" type="checkbox" name="gender_select" value="Sibilings"
                                        id="gender_select_3" />
                                    <span class="form-check-label">Sibilings</span>
                                </label>
                                <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                    <input class="form-check-input" type="checkbox" name="gender_select" value="Married"
                                        id="gender_select_4" />
                            ...
                            <div class = "d-flex  justify-content-between">
                                <div class="mb-5 ">
                                    <p class="form-label fs-6 fw-semibold">Roommates :</p>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="roommate_select" value="1"
                                            id="roommate_select" />
                                        <span class="form-check-label">1</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="roommate_select" value="2"
                                            id="roommate_select_2" />
                                        <span class="form-check-label">2</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="roommate_select" value="3"
                                            id="roommate_select_3" />
                                        <span class="form-check-label">3</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="roommate_select" value="4"
                                            id="roommate_select_4" />
                                        <span class="form-check-label">4</span>
                                    </label>
                                </div>
                                <div class="mb-5 ">
                                    <p class="form-label fs-6 fw-semibold">Capacity :</p>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="capacity_select" value="1"
                                            id="capacity_select" />
                                        <span class="form-check-label">1</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="capacity_select" value="2"
                                            id="capacity_select_2" />
                                        <span class="form-check-label">2</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="capacity_select" value="3"
                                            id="capacity_select_3" />
                                        <span class="form-check-label">3</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="capacity_select" value="4"
                                            id="capacity_select_4" />
                                        <span class="form-check-label">4</span>
                                    </label>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="mb-5">
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid  mb-2">
                                        <input class="form-check-input" type="checkbox" name="pay_select"
                                            value="Expired" id="pay_select_3" />
                                        <span class="form-check-label">Expired</span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--end::Export-->
                                <!--begin::Clean-->
                                <form action="{{ route('admin.deleteExpired') }}" class="mx-3" method="post">
                                    @csrf
                                    <button type="submit" class="btn btn-danger">
                                        ...
                                        <!--end::Svg Icon-->Delete expired
                                    </button>
                                </form>
                                <form action="{{ route('admin.refreshRooms') }}" method="post">
                                    @csrf
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_example">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px">Roommates</th>
                                        <th class="min-w-60px">Capacity</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($rooms as $room)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-gray-800">{{ $room->id }}</td>
                                            ...
                                            <td class="text-gray-800">
                                                <?php $count = 0;?>
                                                @foreach ($room->users as $roommate)
                                                    @if ($roommate->pay_status_pack != 0)
                                                        <?php
                                                        $has_one_paid = 1;
                                                        ?>
                                                    @endif
                                                    <img data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="{{ $roommate->name }} : @if ($roommate->pay_status_pack != 0) PAID @else UNPAID @endif"
                                                        src="{{ $roommate->picture }}" width="20px">
                                                    <?php $count++; ?>
                                                @endforeach
                                                <p class="d-none">{{$count}}</p>
                                            </td>
                                            <td class="text-gray-800">{{ $room->capacity }}</td>
                                            <td class="text-gray-800">{{ $room->code }}</td>
                                            ...
                                            <td>
                                                @if ($room->is_all_paid == 0)
                                                    @if ($has_one_paid == 0)
                                                        ...
                                                        ?>
                                                        @if ($diff >= 1)
                                                            <div class="badge badge-light-warning fw-bold">Expired</div>
                                                        @else
                                            ...
                                            <td class="text-gray-800">
                                                @if ($room->roomLeader != null)
                                                    {{ $room->roomLeader->name }}
                                                @else
                                                    --
                                                @endif
                                            </td>
                                            <td class="text-end">
                                                @if ($room->gender == 2 && $room->confirmed == null)
                                                    <button type="button"
                                                        ...
                                                        onclick="confirm_room('{{ $room->id }}','{{ $room->family_case }}', '{{ $room->note }}', [@foreach ($room->users as $roommate)
                                                                '{{ $roommate->name }}', @endforeach], [@foreach ($room->users as $roommate)
                                                                @if ($roommate->cin_front != null)
                                                                    '{{ asset('/cin/' . $roommate->cin_front) }}',
                                                                @elseif ($roommate->madhmoun != null)
                                                                    '{{ asset('/madhmoun_passport/' . $roommate->madhmoun) }}',
                                                                @endif @endforeach], '{{ asset('/room_proof/' . $room->note) }}')">
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_6">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" id="del_form" action="{{ route('admin.delete_room') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-5" class="col">
                            <div>
                        ...
                        <input type="hidden" name="roomID" id="del_id">
