...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat" data-theme="dark">
                    ...
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <div class="mb-0">
                            ...
                            <a href=""
                                ...
                                <!--end::Svg Icon--></a>
                            <form id="skip-form" action="{{ route('admin.SkipCIN') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </div>
                        <!--end::Link-->
    ...
    <script>
        ...
        uppy.use(Uppy.XHRUpload, {
            endpoint: '{{ route('admin.uploadCinFront') }}',
    ...
    <script>
        ...
        uppy.use(Uppy.XHRUpload, {
            endpoint: '{{ route('admin.uploadCinBack') }}',
    ...
    <script>
        ...
        uppy.use(Uppy.XHRUpload, {
            endpoint: '{{ route('admin.uploadMadhmounPassport') }}',
