    ...
    <div class="toolbar py-5 " id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-white fw-bold my-1 fs-3">Organizers List</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">
                        <a href="index.html" class="text-white text-hover-primary">Dashboard</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">Organizers List</li>
                    <!--end::Item-->
                                ...
                                <div class="mb-5">
                                    ...
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="type_select"
                                            value="Super" id="type_select_3" />
                                        <span class="form-check-label">Super Admin</span>
                                    </label>
                                    <label class="form-check form-check-sm form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="type_select"
                                            value="Admin" id="type_select_4" />
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                @if (Auth::user()->id == 1)
                                    You have &nbsp; <span class="text-primary">{{ $users_bank_count }}</span> &nbsp; bank
                                    transfer @if ($users_bank_count > 1)
                                        operations
                                    @else
                                        operation
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header" id="kt_modal_add_user_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Add Organizer</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                    ...
                                                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fw-semibold fs-6 mb-2">Phone</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fw-semibold fs-6 mb-5">City</label>
                                                                    <select name="city"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fw-semibold fs-6 mb-5">Gender</label>
                                                                    <select name="gender"
                                                                        class="form-select form-select-lg form-select-solid"
                                                                        data-control="select2"
                                                                        data-placeholder="Select..."
                                                        ...
                                                        <div class="mb-7 form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="type" value="payagent" id="flexCheckDefault" />
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_example">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        {{-- <th class="min-w-60px">Is payagent</th> --}}
                                            ...
                                            {{-- <td>
                                                @if ($user->role == 0 || $user->role == 1 || $user->role == 3)
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="green" class="bi bi-check-square-fill"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                ...
                                                @if ($user->role == 2 || $user->role == 3)
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_1"
                                                        ...
                                                        class="btn btn-icon btn-secondary btn-active-icon-success btn-active-text-success"><span
                                                            class="svg-icon svg-icon-1"><svg width="24"
                ...
                <div class="modal-body">
                    ...
                    <form id="kt_account_profile_details_form" class="form" method="POST"
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    <select name="transport" data-control="select2" data-placeholder="--"
                                        ...
                                        class="form-select form-select-solid form-select-lg fw-semibold" id="ed_tran">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Is payagent</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row form-check">
                                    <input class="form-check-input form-control form-control-lg " type="checkbox"
                                        name="type" value="payagent" id="ed_payagent" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                    ...
                    if (response.length == 0) {
                        ...
                        if (response.role > 1) {
                            document.getElementById('btn_edit').innerHTML =
                                "<button href='#'' id='edit_btn' data-bs-toggle='modal' data-bs-target='#kt_modal_1' data-bs-toggle='modal' data-bs-target='#kt_modal_1' class='btn btn-secondary btn-sm'>Edit</button>";
                            document.getElementById('edit_btn').addEventListener("click", getEditInfo(response
                                .id));
                        }
                        // and so on
                    }
