                        ...
                        <div class="card-body pt-0 p-10">
                            ...
                            <ul
                                ...
                                <li class="menu-item mb-1">
                                    <!--begin::Menu link-->
                                    <a class="menu-link px-6 py-4 " href="{{ route('admin.profile') }}">
                ...
                <div class="flex-lg-row-fluid ms-lg-10">
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form id="kt_account_profile_details_form" class="form" method="POST"
                                action="{{ route('adminUpdateInfo') }}" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span>CIN <span class="text-sm text-gray-400">(Once set, it can't be
                                                    modified)</span></span>


                                            <span class="ms-1" data-bs-toggle="tooltip" title="CIN">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            ...
                                            @else
                                                <span
                                                    class="form-control text-gray-500 form-control-lg form-control-solid ">{{ Auth::user()->cin }}</span>
                                            @endif
                                        </div>
                                        <!--end::Col-->
                                    </div>
                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form id="kt_account_profile_details_form" class="form" method="post"
                                action="{{ route('adminUpdatePassword') }}">
                                @csrf
                                <!--begin::Card body-->
                                <div class="card-body border-top p-9">
                                    <!--begin::Input group-->
