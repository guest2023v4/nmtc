                                                                                ...
                                                                                @foreach ($data['room_join_requests'] as $join_request)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="d-flex flex-row">
                                                                                            @if($data['c_rooms'] == 1)
                                                                                            <form method="POST"
                                                                                                action="{{ route('admin.rejectJoinRequest') }}">
                                                                                                @csrf
                                                                                                <button type="submit"
                                                                                            ...
                                                                                            <form method="POST"
                                                                                                action="{{ route('admin.acceptJoinRequest') }}">
                                                                                                @csrf
                                                                                                <button type="submit"
                                                                                                    value="{{ $join_request['id'] }}"
                                                                                                    name="id"
                            ...
                            <div class="card-body p-0 tab-pane fade show " id="kt_tab_pane_4" role="tabpanel">
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <form method="POST" action="{{ route('admin.createReservation') }}" enctype="multipart/form-data">
                                            @csrf
                            ...
                            <div class="card-body p-0 tab-pane fade show " id="kt_tab_pane_5" role="tabpanel">
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <form method="POST" action="{{ route('admin.createJoinRequest') }}">
                                            @csrf
                                                        ...
                                                        <tbody>
                                                            @foreach ($data['rooms_self_join_requests'] as $id => $join_request)
                                                                <tr>
                                                                    ...
                                                                    <td class="d-flex flex-row">
                                                                        <form method="POST"
                                                                            action="{{ route('admin.cancelJoinRequest') }}">
                                                                            @csrf
                                                                            <button type="submit"
                                                                                value="{{ $join_request['id'] }}"
                                                                                name="id"
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('admin.joinPublicRoom') }}">
                                            @csrf
                                            <div class="d-flex justify-content-end">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    @foreach ($data['payagents'] as $agent)
                                                        <form method="POST"
                                                            action="{{ route('admin.choosePaymentAgent') }}">
                                                            @csrf
                                                            <div
                                                    ...
                                                    @if (
                                                        ...
                                                        <div class="drag-drop-area12">
                                                            @if (Auth::user()->bank_transfer)
                                                                <form action="{{ route('admin.removeBankTransfer') }}"
                                                                    method="Post">
                                                                    @csrf
                                                                    <input type="submit"
