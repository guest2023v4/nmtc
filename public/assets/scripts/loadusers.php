...
$sql = "SELECT * FROM user,user_details WHERE user.id = user_details.user_id;";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo '<tr>
													...
													<td class="text-gray-800">#'.$row["id"].'</td>
												
													<td class="d-flex align-items-center">
													
													
														<div class="d-flex flex-column">
															<a href="#" onclick="ViewUser()"
																class="text-gray-800 text-hover-primary mb-1">'.$row["first_name"].'</a>
															<span>'.$row["email"].'</span>
														</div>
													
													</td>
                                                    <td class="text-gray-800">'.$row["phone"].'</td>
													...
													<td>';
                                                        ...
                                                        if ($row["paid"]=="1") {
                                                        echo  '<div class="badge badge-light-success fw-bold">Paid';
                                                    } else {
                                                        echo '<div class="badge badge-light-danger fw-bold">Unpaid';
                                                    }
                                                        echo '</div>
													</td>
